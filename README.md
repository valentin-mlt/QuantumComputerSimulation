Le but projet est de simuler un ordinateur quantique pour s'affranchir des contraintes physiques nécesaires à leur bon fonctionnement dans la réalité (température, bruit, etc).
